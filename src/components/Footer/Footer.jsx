      ...
      <div class="mx-auto grid max-w-screen-xl gap-y-8 gap-x-12 px-4 py-10 md:grid-cols-2 xl:grid-cols-4 xl:px-10">
        <div class="max-w-sm">
          <div class="mb-6 flex h-12 items-center space-x-2">
            <span class="text-2xl font-bold">Heathlog</span>
          </div>
          <div class="text-gray-500">
            Let's start caring for our bodies by maintaining our health because
        ...
        <div class="">
          ...
          <nav aria-label="Footer Navigation" class="text-gray-500">
            <ul class="space-y-3">
              <li>
                <a class="hover:text-blue-600 hover:underline" href="/formhs">
                  BMI
                </a>
              </li>
              <li>
        ...
        <div class="">
          <div class="mt-4 mb-2 font-medium xl:mb-4">
            SMK ASSALAAM PUSAT KEUNGGULAN
          </div>
          <div class="text-gray-500">
            Jl. Situ Tarate Jl. Cibaduyut, <br />
            Cangkuang Kulon, Kec. Dayeuhkolot, <br />
            Kabupaten Bandung, Jawa Barat 40265
          </div>
        </div>
        <div class="mb-6 flex justify-center space-x-2">
          <a
            href="https://x.com/studyzeyy?t=P8E2VqwemgkebSkOxMltwg&s=09"
            type="button"
          ...
          <a
            href="https://www.instagram.com/rachmazn?igsh=MXM2MnJ0and4cGJxdw=="
            type="button"
            class="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
            data-twe-ripple-init
          >
          ...
          <a
            href="https://www.linkedin.com/in/amaliarahma21?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            type="button"
            class="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
            data-twe-ripple-init
          >
          ...
          <a
            href="https://github.com/amaliarahma21"
            type="button"
            class="rounded-full bg-transparent p-3 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-900"
            data-twe-ripple-init
          >
