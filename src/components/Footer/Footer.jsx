                ...
                <div className='left-footer'>
                    ...
                    <div className='logo-social'>
                        <div className='logo-fb'>
                            <a href='' >
                                <img className='fb' src='public/img-product/fb.png' alt='' />
                            </a>
                        </div>
                        <div className='logo-ig'>
                            <a href='' >
                                <img className='ig' src='public/img-product/ig.png' alt='' />
                            </a>
                        </div>
                        <div className='logo-pn'>
                            <a href='' >
                                <img className='pn' src='public/img-product/pn.png' alt='' />
                            </a>
                        </div>
                        <div className='logo-tw'>
                            <a href='' >
                                <img className='tw' src='public/img-product/tw.png' alt='' />
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div className='middle-footer'>
                    ...
                    <div className='copyright'>
                        <div className='frame-copyright'>
                            <img className='icon-copyright' src='public/img-product/copyright.png' alt='' />
                            <h6 className='text-copyright'>Copyright 2023, Designed By BZOTech.com</h6>
                        </div>
                    </div>
                    <div className='vector-footer'>
                        <img className='vector-img' src='public/img-product/vector-copyright.png' alt='' />
                    </div>
                </div>

                {/* <div className='right-footer'>
                    <div className='vector-right-footer'>
                        <img className='right-footer-vector' src='public/img-product/vector-right-footer.png' alt='' />
                    </div>
                    <div className='contact-detail'>
                        <h6 className='title-detail'>Contact Detail</h6>
                        <div className='communication'>
                            <div className='map'>
                                <img className='img-communication' src='public/img-product/map.png' alt='' />
                                <h6 className='title-communication'>600 N Washington
                                    Ave Suite C203</h6>
                            </div>
                            <div className='map'>
                                <img className='img-communication' src='public/img-product/call.png' alt='' />
                                <div className='call'>
                            ...
                            <div className='map'>
                                <img className='img-communication' src='public/img-product/Mail.png' alt='' />
                                <div className='email'>
